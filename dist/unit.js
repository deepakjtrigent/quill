	  ...
	  function Keyboard(quill, options) {
	    ...
	    _this.addBinding({ key: Keyboard.keys.BACKSPACE }, { collapsed: true, prefix: /^.?$/ }, function (range, context) {
	      ...
	      var _quill$scroll$line = this.quill.scroll.line(range.index),
	          _quill$scroll$line2 = _slicedToArray(_quill$scroll$line, 1),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _multiCursor = __webpack_require__(69);
...
/***/ (function(module, exports) {
	...
	var MultiCursor = function () {
	  ...
	  _createClass(MultiCursor, [{
	    ...
	    value: function applyDelta(delta) {
	      ...
	      delta.ops.forEach(function (op) {
	        ...
	        if (op.insert) {
	          ...
	          _this3.shiftCursors(index, length, author);
	        } else if (op.delete) {
	          _this3.shiftCursors(index, -1 * op.delete, null);
	        } else if (op.retain) {
	          _this3.shiftCursors(index, 0, null);
	          length = op.retain;
	        }
	        index += length;
	      });
	    ...
	    key: 'buildCursor',
	    value: function buildCursor(name, color) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function compareNodes(node1, node2) {
	  ...
	  if (node1.nodeType === node1.ELEMENT_NODE) {
	    ...
	    if (!(0, _deepEqual2.default)(_attr, _attr2)) {
	      return 'Expected attributes ' + jasmine.pp(_attr) + ' to equal ' + jasmine.pp(_attr2);
	    }
	    ...
	    if ([].some.call(node1.childNodes, function (child1, i) {
	      _message = compareNodes(child1, node2.childNodes[i], ignoredAttributes);
	      return _message;
	    })) {
	      return _message;
	    }
